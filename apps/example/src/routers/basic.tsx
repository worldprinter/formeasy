import { NestedValue, useForm, ValidationMode } from '@worldprinter/formeasy'
...
const Basic: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <select
                multiple
                {...register('multiple', { required: true })}
            >
            ...
            <div id='on-invalid-called-times'>onInvalid callback called {onInvalidCalledTimes} times</div>
