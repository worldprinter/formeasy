import { useForm, type DefaultValues } from '@worldprinter/formeasy'
    ...
    return (
        <form>
            ...
            <fieldset>
                ...
                <textarea
                    id='focusTextarea'
                    {...register('focusTextarea')}
                />
                <button
                    type='button'
                    onClick={() => setFocus('focusTextarea')}
                >
                    Focus Textarea
                </button>
            </fieldset>
            <fieldset>
                ...
                <button
                    type='button'
                    onClick={() => setFocus('selectTextareaContent', { shouldSelect: true })}
                >
