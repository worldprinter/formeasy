import { Control, useForm, useFormState } from '@worldprinter/formeasy'
...
const SubForm = ({ control }: { control: Control<FormInputs> }) => {
    const { isDirty, dirtyFields, touchedFields, isSubmitted, isSubmitSuccessful, submitCount, isValid } = useFormState(
        {
            control,
        },
    )
