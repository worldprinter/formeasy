 ...
 */
export type FormikComputedProps<Values> = {
...
export type FormikHandlers = {
    ...
    handleBlur: {
        ...
        /** Preact-like linkState. Will return a handleBlur function. */ <T = string | any>(
            fieldOrEvent: T,
    ...
    handleChange: {
        ...
        /** Preact-like linkState. Will return a handleChange function.  */ <T = string | React.ChangeEvent<any>>(
            field: T,
 ...
 */
export type FormikSharedConfig<Props = {}> = {
...
export type FormikConfig<Values> = {
    ...
    watch?: Record<PropertyKey, (value: any, formValue: Values) => void>
} & FormikSharedConfig
...
export type FormikRegistration = {
...
export type SharedRenderProps<T> = {
    /**
...
/** Field metadata */
export type FieldMetaProps<Value> = {
    /** Value of the field */
    value: Value
...
export type FieldHelperProps<Value> = {
