...
export type FastFieldProps<V = any> = {
...
type FastFieldInnerProps<Values = {}, Props = {}> = FastFieldAttributes<Props> & { formik: FormikContextType<Values> }

/**
 * Custom Field component for quickly hooking into Formik
 * context and wiring up forms.
 */
class FastFieldInner<Values = {}, Props = {}> extends React.Component<FastFieldInnerProps<Values, Props>, {}> {
