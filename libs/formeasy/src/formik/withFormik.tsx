...
import type { FormikErrors, FormikHelpers, FormikProps, FormikSharedConfig, FormikTouched, FormikValues } from './types'
 ...
 */
export type WithFormikConfig<Props, Values extends FormikValues = FormikValues, DeprecatedPayload = Values> = {
    /**
...
export function withFormik<OuterProps extends object, Values extends FormikValues, Payload = Values>({
    ...
    ...config
}: WithFormikConfig<OuterProps, Values, Payload>): ComponentDecorator<OuterProps, OuterProps & FormikProps<Values>> {
