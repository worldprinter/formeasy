...
export class SelectorMatcher<T = any> {
     ...
     */
    private _addSelectable(cssSelector: CssSelector, callbackCtxt: T, listContext: SelectorListContext) {
    ...
    private _addTerminal(map: Map<string, SelectorContext<T>[]>, name: string, selectable: SelectorContext<T>) {
...
export class SelectorContext<T = any> {
    ...
    constructor(public selector: CssSelector, public cbContext: T, public listContext: SelectorListContext) {
