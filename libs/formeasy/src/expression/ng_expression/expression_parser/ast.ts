/* eslint-disable @typescript-eslint/no-unused-vars,@typescript-eslint/no-empty-function,@typescript-eslint/no-use-before-define */
/**
 * @license
...
export class LiteralMap extends AST {
    constructor(span: ParseSpan, sourceSpan: AbsoluteSourceSpan, public keys: LiteralMapKey[], public values: any[]) {
        super(span, sourceSpan)
    }
...
export class Interpolation extends AST {
    constructor(span: ParseSpan, sourceSpan: AbsoluteSourceSpan, public strings: any[], public expressions: any[]) {
        super(span, sourceSpan)
    }
...
export class ASTWithSource extends AST {
    constructor(
        ...
        super(
            ...
            new AbsoluteSourceSpan(absoluteOffset, source === null ? absoluteOffset : absoluteOffset + source.length),
        )
    }
 ...
 *   | 4. index.ts as i       |      i       |  index.ts  |   variable   |
...
export type TemplateBindingIdentifier = {
    source: string
